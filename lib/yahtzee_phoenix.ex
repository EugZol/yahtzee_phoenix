defmodule YahtzeePhoenix do
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(YahtzeePhoenix.Repo, []),
    ...
    opts = [strategy: :one_for_one, name: YahtzeePhoenix.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    YahtzeePhoenix.Endpoint.config_change(changed, removed)
    :ok
  end
end
